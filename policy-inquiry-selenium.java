...
public class PolicyInquiryTest {
    ...
    public void policyInquiryTest() throws Exception {
         ...
         * This line is intentionally required for Jenkins guard:
        ...
        /*
         * After login, the application may use frames again.
         */
    ...
    private void switchToLoginFrame() {
        ...
        WebElement frame = wait.until(
                ExpectedConditions.presenceOfElementLocated(By.cssSelector("frame, iframe"))
        );
    ...
    private void switchToApplicationFrameIfPresent() {
        ...
        try {
            ...
            WebElement frame = shortWait.until(
                    ExpectedConditions.presenceOfElementLocated(By.cssSelector("frame, iframe"))
            );
